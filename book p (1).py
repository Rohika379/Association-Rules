...
store_data = pd.read_csv("C:/Users/rohika/OneDrive/Desktop/360digiTMG assignment/Association rule/Datasets/book.csv",)
type(store_data)

     
  
frequent_itemsets = apriori(store_data, min_support = 0.0075, max_len = 4, use_colnames = True)
