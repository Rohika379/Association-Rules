...
data = pd.read_csv("C:\\Users\\rohika\\OneDrive\\Desktop\\360digiTMG assignment\\Association rule\\Datasets\\myphonedata.csv")

dataset= data.rename(columns={'V1':'V1', 'V2':'V2','V3':'V3'})

dataset1 =  dataset.drop(['V1','V2','V3'], axis=1)
